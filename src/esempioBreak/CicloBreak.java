...
public class CicloBreak {
	...
	public static void main(String[] args) {
		...
		for(int punteggioSingolo : punteggi) {
			// punteggioSingolo assume ciascuno dei valori dell'array punteggi (4, poi 6 poi 2 ecc), non è l'indice
			
			if (punteggioSingolo > punteggioMin) {
				superato = true;
				System.out.println(punteggioSingolo);
				break; //esce dal ciclo perché la condizione è soddisfatta
			}
		}
