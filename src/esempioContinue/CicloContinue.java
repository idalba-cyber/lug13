...
public class CicloContinue {
	...
	public static void main(String[] args) {
		...
		for(int punteggioSingolo : punteggi) {
			...
			if(punteggioSingolo <= punteggioMin) {//se la condizione non è soddisfatta svolgi un Continue
				
				continue; // torna all'inizio del ciclo ignorando quando segue
			...
			// max() evita di visualizzare valori negativi se punteggioMin è superato più di 3 volte
